...
\NormalTok{  {-}\textgreater{} 尝试 DROP DATABASE physicalName}
\NormalTok{  {-}\textgreater{} 记录失败审计}
\NormalTok{  {-}\textgreater{} 返回系统错误}
\end{Highlighting}
\end{Shaded}

\hypertarget{physicalname-ux751fux6210}{%
\subsubsection{7.2 physicalName 生成}\label{physicalname-ux751fux6210}}

规则：

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dbapp\_u\{userID\}\_\{displayName\}\_\{suffix\}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{5. 校验 orderBy 是否真实字段。}
\NormalTok{6. 构造 SELECT。}
...
\NormalTok{6. 构造 UPDATE ... WHERE pk = ?。}
\NormalTok{7. 执行更新。}
\NormalTok{8. 写入审计日志。}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  physicalName}\OperatorTok{:} \DataTypeTok{string}\OperatorTok{;}
...
\NormalTok{3. USE \textasciigrave{}physicalName\textasciigrave{}。}
...
\NormalTok{3. 查询 information\_schema.columns。}
\NormalTok{4. 聚合表数量、视图数量、数据大小、索引大小。}
\NormalTok{5. 统计字段类型分布。}
\NormalTok{6. 查询 audit\_logs 得到最近操作。}
\end{Highlighting}
\end{Shaded}
...
\item
  ...
  \texttt{SEC-AUTHZ}。
\item
  用户资源：对应需求 \texttt{REQ-ASSET}；对应接口后续补充
...
\NormalTok{  account\_no }\DataTypeTok{VARCHAR}\NormalTok{(}\DecValTok{10}\NormalTok{) }\KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{UNIQUE} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}10 位登录账号\textquotesingle{}}\NormalTok{,}
\NormalTok{  password\_hash }\DataTypeTok{VARCHAR}\NormalTok{(}\DecValTok{255}\NormalTok{) }\KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}bcrypt 密码哈希\textquotesingle{}}\NormalTok{,}
...
\NormalTok{  last\_login\_time DATETIME }\KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}最近登录时间\textquotesingle{}}\NormalTok{,}
\NormalTok{  register\_time }\DataTypeTok{TIMESTAMP} \KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{DEFAULT} \FunctionTok{CURRENT\_TIMESTAMP} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}注册时间\textquotesingle{}}\NormalTok{,}
\NormalTok{  updated\_at }\DataTypeTok{TIMESTAMP} \KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{DEFAULT} \FunctionTok{CURRENT\_TIMESTAMP} \KeywordTok{ON} \KeywordTok{UPDATE} \FunctionTok{CURRENT\_TIMESTAMP} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}更新时间\textquotesingle{}}\NormalTok{,}
  ...
  \KeywordTok{INDEX}\NormalTok{ idx\_users\_account\_no (account\_no),}
  \KeywordTok{INDEX}\NormalTok{ idx\_users\_status (status)}
\NormalTok{) }\KeywordTok{COMMENT}\OperatorTok{=}\StringTok{\textquotesingle{}用户认证表\textquotesingle{}}\NormalTok{;}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  display\_name }\DataTypeTok{VARCHAR}\NormalTok{(}\DecValTok{50}\NormalTok{) }\KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}展示昵称\textquotesingle{}}\NormalTok{,}
\NormalTok{  avatar\_asset\_id BIGINT UNSIGNED }\KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}头像资源 ID\textquotesingle{}}\NormalTok{,}
\NormalTok{  bio }\DataTypeTok{VARCHAR}\NormalTok{(}\DecValTok{255}\NormalTok{) }\KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}个人简介\textquotesingle{}}\NormalTok{,}
...
\NormalTok{  updated\_at }\DataTypeTok{TIMESTAMP} \KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{DEFAULT} \FunctionTok{CURRENT\_TIMESTAMP} \KeywordTok{ON} \KeywordTok{UPDATE} \FunctionTok{CURRENT\_TIMESTAMP} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}更新时间\textquotesingle{}}\NormalTok{,}
  ...
  \KeywordTok{CONSTRAINT}\NormalTok{ fk\_user\_profiles\_user}
...
\NormalTok{  user\_id }\DataTypeTok{INT} \KeywordTok{PRIMARY} \KeywordTok{KEY} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}用户 ID\textquotesingle{}}\NormalTok{,}
\NormalTok{  theme\_mode ENUM(}\StringTok{\textquotesingle{}dark\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}light\textquotesingle{}}\NormalTok{) }\KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{DEFAULT} \StringTok{\textquotesingle{}dark\textquotesingle{}} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}主题模式\textquotesingle{}}\NormalTok{,}
\NormalTok{  theme\_hue }\DataTypeTok{SMALLINT}\NormalTok{ UNSIGNED }\KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{DEFAULT} \DecValTok{210} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}主题色相，0{-}359\textquotesingle{}}\NormalTok{,}
\NormalTok{  background\_preset }\DataTypeTok{VARCHAR}\NormalTok{(}\DecValTok{50}\NormalTok{) }\KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{DEFAULT} \StringTok{\textquotesingle{}particle\textquotesingle{}} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}背景预设\textquotesingle{}}\NormalTok{,}
\NormalTok{  background\_asset\_id BIGINT UNSIGNED }\KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}背景资源 ID\textquotesingle{}}\NormalTok{,}
\NormalTok{  table\_page\_size }\DataTypeTok{INT}\NormalTok{ UNSIGNED }\KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{DEFAULT} \DecValTok{20} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}表格默认分页大小\textquotesingle{}}\NormalTok{,}
\NormalTok{  confirm\_batch\_insert }\DataTypeTok{BOOLEAN} \KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{DEFAULT} \KeywordTok{TRUE} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}批量插入确认\textquotesingle{}}\NormalTok{,}
\NormalTok{  confirm\_batch\_update }\DataTypeTok{BOOLEAN} \KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{DEFAULT} \KeywordTok{TRUE} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}批量修改确认\textquotesingle{}}\NormalTok{,}
\NormalTok{  confirm\_batch\_delete }\DataTypeTok{BOOLEAN} \KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{DEFAULT} \KeywordTok{TRUE} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}批量删除确认\textquotesingle{}}\NormalTok{,}
\NormalTok{  confirm\_cascade\_delete }\DataTypeTok{BOOLEAN} \KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{DEFAULT} \KeywordTok{TRUE} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}级联删除确认\textquotesingle{}}\NormalTok{,}
\NormalTok{  created\_at }\DataTypeTok{TIMESTAMP} \KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{DEFAULT} \FunctionTok{CURRENT\_TIMESTAMP} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}创建时间\textquotesingle{}}\NormalTok{,}
\NormalTok{  updated\_at }\DataTypeTok{TIMESTAMP} \KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{DEFAULT} \FunctionTok{CURRENT\_TIMESTAMP} \KeywordTok{ON} \KeywordTok{UPDATE} \FunctionTok{CURRENT\_TIMESTAMP} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}更新时间\textquotesingle{}}\NormalTok{,}

  \KeywordTok{CONSTRAINT}\NormalTok{ fk\_user\_preferences\_user}
    \KeywordTok{FOREIGN} \KeywordTok{KEY}\NormalTok{ (user\_id) }\KeywordTok{REFERENCES}\NormalTok{ users(}\KeywordTok{id}\NormalTok{)}
...
\KeywordTok{CREATE} \KeywordTok{TABLE} \ControlFlowTok{IF} \KeywordTok{NOT} \KeywordTok{EXISTS}\NormalTok{ user\_assets (}
  \KeywordTok{id}\NormalTok{ BIGINT UNSIGNED AUTO\_INCREMENT }\KeywordTok{PRIMARY} \KeywordTok{KEY} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}资源 ID\textquotesingle{}}\NormalTok{,}
\NormalTok{  user\_id }\DataTypeTok{INT} \KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}所属用户 ID\textquotesingle{}}\NormalTok{,}
...
\NormalTok{  deleted\_at DATETIME }\KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}删除时间\textquotesingle{}}\NormalTok{,}
  ...
  \KeywordTok{INDEX}\NormalTok{ idx\_user\_assets\_user\_type (user\_id, asset\_type),}
  \KeywordTok{INDEX}\NormalTok{ idx\_user\_assets\_status (status),}

  \KeywordTok{CONSTRAINT}\NormalTok{ fk\_user\_assets\_user}
    \KeywordTok{FOREIGN} \KeywordTok{KEY}\NormalTok{ (user\_id) }\KeywordTok{REFERENCES}\NormalTok{ users(}\KeywordTok{id}\NormalTok{)}
...
\KeywordTok{CREATE} \KeywordTok{TABLE} \ControlFlowTok{IF} \KeywordTok{NOT} \KeywordTok{EXISTS}\NormalTok{ refresh\_tokens (}
  \KeywordTok{id}\NormalTok{ BIGINT UNSIGNED AUTO\_INCREMENT }\KeywordTok{PRIMARY} \KeywordTok{KEY} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}Refresh Token ID\textquotesingle{}}\NormalTok{,}
...
\NormalTok{  token\_hash }\DataTypeTok{VARCHAR}\NormalTok{(}\DecValTok{255}\NormalTok{) }\KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}Refresh Token 哈希\textquotesingle{}}\NormalTok{,}
\NormalTok{  token\_family }\DataTypeTok{VARCHAR}\NormalTok{(}\DecValTok{64}\NormalTok{) }\KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}Token 家族 ID\textquotesingle{}}\NormalTok{,}
...
\NormalTok{  revoked\_at DATETIME }\KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}撤销时间\textquotesingle{}}\NormalTok{,}
\NormalTok{  replaced\_by\_token\_id BIGINT UNSIGNED }\KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}轮换后的新 Token ID\textquotesingle{}}\NormalTok{,}
\NormalTok{  created\_ip }\DataTypeTok{VARCHAR}\NormalTok{(}\DecValTok{45}\NormalTok{) }\KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}创建 IP\textquotesingle{}}\NormalTok{,}
...
\NormalTok{  created\_at }\DataTypeTok{TIMESTAMP} \KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{DEFAULT} \FunctionTok{CURRENT\_TIMESTAMP} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}创建时间\textquotesingle{}}\NormalTok{,}
  ...
  \KeywordTok{UNIQUE} \KeywordTok{KEY}\NormalTok{ uk\_refresh\_token\_hash (token\_hash),}
  \KeywordTok{INDEX}\NormalTok{ idx\_refresh\_tokens\_user (user\_id),}
  \KeywordTok{INDEX}\NormalTok{ idx\_refresh\_tokens\_family (token\_family),}
  \KeywordTok{INDEX}\NormalTok{ idx\_refresh\_tokens\_expires (expires\_at),}

  \KeywordTok{CONSTRAINT}\NormalTok{ fk\_refresh\_tokens\_user}
    \KeywordTok{FOREIGN} \KeywordTok{KEY}\NormalTok{ (user\_id) }\KeywordTok{REFERENCES}\NormalTok{ users(}\KeywordTok{id}\NormalTok{)}
\NormalTok{) }\KeywordTok{COMMENT}\OperatorTok{=}\StringTok{\textquotesingle{}Refresh Token 表\textquotesingle{}}\NormalTok{;}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{CREATE} \KeywordTok{TABLE} \ControlFlowTok{IF} \KeywordTok{NOT} \KeywordTok{EXISTS}\NormalTok{ user\_databases (}
  \KeywordTok{id}\NormalTok{ BIGINT UNSIGNED AUTO\_INCREMENT }\KeywordTok{PRIMARY} \KeywordTok{KEY} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}平台数据库 ID\textquotesingle{}}\NormalTok{,}
\NormalTok{  user\_id }\DataTypeTok{INT} \KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}所属用户 ID\textquotesingle{}}\NormalTok{,}
\NormalTok{  display\_name }\DataTypeTok{VARCHAR}\NormalTok{(}\DecValTok{64}\NormalTok{) }\KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}用户看到的数据库名称\textquotesingle{}}\NormalTok{,}
\NormalTok{  physical\_name }\DataTypeTok{VARCHAR}\NormalTok{(}\DecValTok{128}\NormalTok{) }\KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}MySQL 中真实数据库名称\textquotesingle{}}\NormalTok{,}
\NormalTok{  charset\_name }\DataTypeTok{VARCHAR}\NormalTok{(}\DecValTok{32}\NormalTok{) }\KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{DEFAULT} \StringTok{\textquotesingle{}utf8mb4\textquotesingle{}} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}字符集\textquotesingle{}}\NormalTok{,}
\NormalTok{  collation\_name }\DataTypeTok{VARCHAR}\NormalTok{(}\DecValTok{64}\NormalTok{) }\KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{DEFAULT} \StringTok{\textquotesingle{}utf8mb4\_unicode\_ci\textquotesingle{}} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}排序规则\textquotesingle{}}\NormalTok{,}
\NormalTok{  status ENUM(}\StringTok{\textquotesingle{}active\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}deleted\textquotesingle{}}\NormalTok{) }\KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{DEFAULT} \StringTok{\textquotesingle{}active\textquotesingle{}} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}状态\textquotesingle{}}\NormalTok{,}
\NormalTok{  created\_at }\DataTypeTok{TIMESTAMP} \KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{DEFAULT} \FunctionTok{CURRENT\_TIMESTAMP} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}创建时间\textquotesingle{}}\NormalTok{,}
\NormalTok{  updated\_at }\DataTypeTok{TIMESTAMP} \KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{DEFAULT} \FunctionTok{CURRENT\_TIMESTAMP} \KeywordTok{ON} \KeywordTok{UPDATE} \FunctionTok{CURRENT\_TIMESTAMP} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}更新时间\textquotesingle{}}\NormalTok{,}
\NormalTok{  deleted\_at DATETIME }\KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}删除时间\textquotesingle{}}\NormalTok{,}

  \KeywordTok{UNIQUE} \KeywordTok{KEY}\NormalTok{ uk\_user\_database\_display (user\_id, display\_name),}
  \KeywordTok{UNIQUE} \KeywordTok{KEY}\NormalTok{ uk\_user\_database\_physical (physical\_name),}
  \KeywordTok{INDEX}\NormalTok{ idx\_user\_databases\_user\_status (user\_id, status),}

  \KeywordTok{CONSTRAINT}\NormalTok{ fk\_user\_databases\_user}
    \KeywordTok{FOREIGN} \KeywordTok{KEY}\NormalTok{ (user\_id) }\KeywordTok{REFERENCES}\NormalTok{ users(}\KeywordTok{id}\NormalTok{)}
\NormalTok{) }\KeywordTok{COMMENT}\OperatorTok{=}\StringTok{\textquotesingle{}用户数据库归属表\textquotesingle{}}\NormalTok{;}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dbapp\_u\{userId\}\_\{safeDisplayName\}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  user\_id }\DataTypeTok{INT} \KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}用户 ID\textquotesingle{}}\NormalTok{,}
\NormalTok{  database\_id BIGINT UNSIGNED }\KeywordTok{NOT} \KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}平台数据库 ID\textquotesingle{}}\NormalTok{,}
...
\NormalTok{  database\_id BIGINT UNSIGNED }\KeywordTok{NULL} \KeywordTok{COMMENT} \StringTok{\textquotesingle{}平台数据库 ID\textquotesingle{}}\NormalTok{,}
...
\item
  ...
  \tightlist
  \item
    \texttt{uk\_user\_display\_name(user\_id,\ display\_name)}：唯一索引；同一用户下数据库显示名唯一。
  \item
    \texttt{uk\_physical\_name(physical\_name)}：唯一索引；真实物理库名唯一。
  \item
    \texttt{idx\_user\_db\_status(user\_id,\ status)}：普通索引；查询当前用户有效数据库。
  \end{itemize}
\item
...
查询 \texttt{user\_databases} 成功后才能获得 \texttt{physical\_name}。
...
\tightlist
\item
  数据库真实名来自 \texttt{user\_databases.physical\_name}。
\item
